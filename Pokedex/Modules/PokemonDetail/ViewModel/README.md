...
```
cd existing_repo
git remote add origin https://pscode.lioncloud.net/anksharm56/pokemon.git
git branch -M main
...
- [ ] [Set up project integrations](https://pscode.lioncloud.net/anksharm56/pokemon/-/settings/integrations)
